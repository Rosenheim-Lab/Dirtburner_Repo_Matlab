function [D,Dn,Tmax]=DecompDB(filename,Int)
%************Decompose Dirt Burner Data************************************
%
%FOR USE ON RUNS PRIOR TO 23MAY2012!!!!
%
...
D=load(filename);
D0=D(:,4)-min(D(:,4));
Dn=[D(:,1) D0./sum(D0)*length(D0)/10000;];  %normalized to measurement
...
plot(D(:,1),D0,'k','LineWidth',2) %plot zeroed pCO2
